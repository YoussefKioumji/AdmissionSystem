...
<html>
    ...
    <body>
        ...
        <a href="${pageContext.request.contextPath}/app/registration"><fmt:message key="header.registration"/></a>
        <a href="${pageContext.request.contextPath}/app/login"><fmt:message key="header.login"/></a>
    </body>
</html>