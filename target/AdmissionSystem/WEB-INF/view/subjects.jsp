...
<html>
    <body>
        ...
        <fmt:message key="subjects.title" var="pageTitle"/>
        ...
        <table>
            <thead>
                <tr>
                    <th><fmt:message key="subjects.id"/></th>
                    <th><fmt:message key="subjects.name"/></th>
                    <th><fmt:message key="subjects.questions"/></th>
                    <th><fmt:message key="subjects.maximum"/></th>
                    <th><fmt:message key="subjects.minimum"/></th>
                </tr>
            </thead>
            <tbody>
